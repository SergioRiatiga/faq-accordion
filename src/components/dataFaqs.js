const dataFaqs = [
  {
    ...
    answer:
      'Frontend Mentor offers realistic coding challenges to help developers improve  their frontend coding skills with projects in HTML, CSS and JavaScript.It is suitable for all levels and ideal for porfolio building.',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: 'Can I use Front Mentor projects in my porfolio?',
    answer:
